...
X_bush = np.column_stack([np.ones_like(summer), tground[:, 0], summer,
                     summer_tground[:, 0],
                     prev_bush, prev_open, prev_rock, prev_bush_tground[:, 0], prev_open_tground[:, 1], prev_rock_tground[:, 2],
                     prev_bush_summer, prev_rock_summer , prev_open_summer, prev_bush_summer_tground[:, 0]])


X_open = np.column_stack([np.ones_like(summer), tground[:, 1], summer,
                     summer_tground[:, 1],
                     prev_bush, prev_open, prev_rock, prev_bush_tground[:, 0], prev_open_tground[:, 1], prev_rock_tground[:, 2],
                     prev_bush_summer, prev_rock_summer , prev_open_summer, prev_open_summer_tground[:, 1] ])

X_rock = np.column_stack([np.ones_like(summer), tground[:, 2], summer,
                     summer_tground[:, 2],
                     prev_bush, prev_open, prev_rock, prev_bush_tground[:, 0], prev_open_tground[:, 1], prev_rock_tground[:, 2],
                     prev_bush_summer, prev_rock_summer , prev_open_summer, prev_rock_summer_tground[:, 2] ])
...
print(summary)
summary.to_csv("trace_category_model_simp1.csv")
...
trace.to_netcdf("trace_category_models_simp1.nc")
pp_samples.to_netcdf("trace_category_models_simp1.nc")
