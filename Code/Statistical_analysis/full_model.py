...
# Add 'prev_bush' and 'prev_rock' to the X matrix, and remove 'bush', 'rock', and their interactions
...
X_bush = np.column_stack([np.ones_like(summer), tground[:, 0], summer,
                     ...
                     prev_bush_summer, prev_rock_summer , prev_open_summer, prev_bush_summer_tground[:, 0], prev_open_summer_tground[:, 1], prev_rock_summer_tground[:, 2] ])
...
print(summary)
summary.to_csv("gavin_trace_category_models1.csv")
...
trace.to_netcdf("trace_category_models_full.nc")
pp_samples.to_netcdf("trace_category_models_full.nc")
